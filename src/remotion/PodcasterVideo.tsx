...
const CsvFileCard: React.FC<{ filename: string; meta?: string; label?: string }> = ({ filename, meta, label = "CSV" }) => (
  <div
    style={{
      display: "flex",
      alignItems: "center",
...
const TheTrigger: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ opacity: enterOp }}>
      <Img
        src={staticFile("storyboard/podcast-1.jpg")}
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "flex-start" }}>
          <SlackBubble
            ...
            initials="JK"
            time="8:42 AM"
            message="Maya Patel confirmed for tomorrow at 9am 🎙️"
          />
          <SlackBubble
            frame={frame}
            fps={fps}
            ...
            initials="JK"
            time="8:43 AM"
            message="She runs NeuralPath — can you pull some background on her?"
          />
        </div>
      </AbsoluteFill>
    </AbsoluteFill>
...
const PROMPT_TEXT =
  "Use Massive to /search information about Maya Patel, CEO of NeuralPath. Find recent news, funding rounds, LinkedIn profile, and past podcast appearances.";
const AI_RESPONSE = "On it — searching the web, LinkedIn, and podcast databases now.";
...
const ThePromptAndResult: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <Img
        src={staticFile("storyboard/podcast-2.jpg")}
        style={{ width: "100%", height: "100%", objectFit: "cover", transform: `scale(${zoomScale})` }}
      />
      <DotGrid opacity={0.07} />
      <Sequence from={158}>
          ...
          <div style={{ padding: "28px 28px", display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 14 }}>
              ...
              <div style={{ position: "relative", flex: 1 }}>
                ...
                >
                  <div style={{ color: CREAM, fontFamily, fontSize: 28, lineHeight: 1.55 }}>
                    Got it. Here's Maya's full profile:
                  </div>
                  <div style={{ opacity: csvOp }}>
                    <CsvFileCard
                      filename="maya_patel_brief.doc"
                      meta="Research · 12 sources found"
                      label="DOC"
                    />
                  </div>
                </div>
...
const Outro: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <Img
        src={staticFile("storyboard/podcast-3.jpg")}
        style={{ width: "100%", height: "100%", objectFit: "cover", transform: `scale(${zoomScale})` }}
      />
...
export const PodcasterVideo: React.FC = () => {
  const { durationInFrames } = useVideoConfig();
  return (
    <AbsoluteFill style={{ backgroundColor: BG }}>
      <Audio
        src={staticFile("music/the_mountain-instrumental-513154.mp3")}
