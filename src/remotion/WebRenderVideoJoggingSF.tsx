...
const Hook: React.FC = () => {
  ...
  const logoSty = si(frame, fps, 0);
  const line1Sty = wp(frame, 4, 8);
  const line2Sty = wp(frame, 12, 10);
  const eyebrowSty = up(frame, fps, 16);
...
const TheTrigger: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ opacity: enterOp }}>
      <OffthreadVideo
        src={staticFile("videos/Jogging 1.mp4")}
        trimBefore={0}
        muted
...
const ThePromptAndResult: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <OffthreadVideo
        src={staticFile("videos/Jogging 2.mp4")}
        trimBefore={0}
        muted
        style={{ objectFit: "cover", width: "100%", height: "100%" }}
      />
...
const Outro: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <OffthreadVideo
        src={staticFile("videos/Jogging 3.mp4")}
        trimBefore={70}
        muted
        style={{ objectFit: "cover", width: "100%", height: "100%" }}
      />
...
export const WebRenderVideoJoggingSF: React.FC = () => {
  const { durationInFrames } = useVideoConfig();
  return (
    <AbsoluteFill style={{ backgroundColor: BG }}>
      <Audio
        src={staticFile("music/bombinsound-corporate-advertising-512486.mp3")}
        trimBefore={113}
        volume={(f) =>
          interpolate(f, [0, 30], [0, 1], C) *
