...
const TheTrigger: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ opacity: enterOp }}>
      <OffthreadVideo
        src={staticFile("videos/A_technicial_using_his_phone,_202605041054.mp4")}
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "flex-start" }}>
          <SlackBubble
            ...
            initials="AM"
            time="3:22 PM"
            message="The GPU burned out — might need a Z790 board too"
          />
          <SlackBubble
            frame={frame}
            fps={fps}
            ...
            initials="AM"
            time="3:23 PM"
            message="Can I have it ready for this weekend?"
          />
        </div>
      </AbsoluteFill>
    </AbsoluteFill>
...
const PROMPT_TEXT =
  "Find lowest prices for: RTX 4090, ASUS ROG Z790-F, 64GB Corsair DDR5. Check Newegg, Amazon, and MicroCenter.";
const AI_RESPONSE = "On it — scraping Newegg, Amazon, and MicroCenter for live prices now.";
...
const ThePromptAndResult: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <Img
        src={staticFile("storyboard/pc-repair-2.jpg")}
          ...
          <div style={{ padding: "28px 28px", display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 14 }}>
              ...
              <div style={{ position: "relative", flex: 1 }}>
                ...
                >
                  <div style={{ color: CREAM, fontFamily, fontSize: 28, lineHeight: 1.55 }}>
                    Got the cheapest options across all three stores:
                  </div>
                  <div style={{ opacity: csvOp }}>
                    <CsvFileCard filename="parts_prices.csv" meta="3 parts · Lowest prices found" />
                  </div>
                </div>
              </div>
            </div>
...
const Outro: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <Img
        src={staticFile("storyboard/pc-repair-3.jpg")}
        style={{ width: "100%", height: "100%", objectFit: "cover", transform: `scale(${zoomScale})` }}
      />
...
export const PCRepairVideo: React.FC = () => {
  const { durationInFrames } = useVideoConfig();
  return (
    <AbsoluteFill style={{ backgroundColor: BG }}>
      <Audio
        src={staticFile("music/monume-house-519225.mp3")}
